# Built with `angular-seed` — the seed for AngularJS apps

This project is build with Angular seed, an application skeleton for a typical [AngularJS][angularjs] web app. 

The setup instructions are pretty much the same, so I'll leave them in.
